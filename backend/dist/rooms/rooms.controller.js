...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new multiplayer room' }),
...
__decorate([
    (0, common_1.Get)(':code'),
    (0, swagger_1.ApiOperation)({ summary: 'Get room by code' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get participants of a room' }),
