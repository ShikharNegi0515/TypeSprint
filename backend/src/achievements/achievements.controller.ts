...
export class AchievementsController {
  ...
  @Get('progress')
  @ApiOperation({
    summary: 'Get all achievements with unlock status and progress',
  })
  getAllProgress(@CurrentUser() user: User) {
  ...
  awardSpecial(@CurrentUser() user: User, @Param('id') achievementId: string) {
