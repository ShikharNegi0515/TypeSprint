    ...
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Join the typing revolution</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-primary text-primary-foreground font-semibold rounded-lg hover:opacity-90 transition-opacity flex justify-center items-center mt-4"
          >
